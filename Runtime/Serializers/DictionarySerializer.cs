...
namespace USerialization
{
    ...
    public class DictionarySerializer : ISerializationProvider
    {
        ...
        public unsafe bool TryGetSerializationMethods(Type type, out SerializationMethods methods)
        {
            ...
            methods = new SerializationMethods(instance.Write, instance.Read, DataType.Object);
            return true;
        }
